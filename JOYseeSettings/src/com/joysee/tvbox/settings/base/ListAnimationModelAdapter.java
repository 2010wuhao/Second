...
public class ListAnimationModelAdapter extends BaseAdapter {
    ...
    public ListAnimationModelAdapter(Context context, ArrayList<ListItem> array, boolean isNarrow) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            int width;
            if (isNarrow) {
                convertView = mInflater.inflate(R.layout.view_settings_model_narrow_item, null);
                width = mContext.getResources().getDimensionPixelSize(R.dimen.list_settings_item_narrow_width);
            } else {
                convertView = mInflater.inflate(R.layout.view_settings_model_item, null);
