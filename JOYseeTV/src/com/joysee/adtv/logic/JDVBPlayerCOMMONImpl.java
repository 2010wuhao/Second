 ...
 * =====================================================================
 *
 * @file  JDVBPlayerCOMMONImpl.java
 ...
 * ----------      ------------     -------------     -----------
 * YueLiang         2014年4月9日            1.0          Check for NULL, 0 h/w
 * =====================================================================
 **/
//
...
class JDVBPlayerCOMMONImpl extends JDVBPlayer {
    static {
        System.loadLibrary("tsplayer");
        System.loadLibrary("tvsearchlocal");
    ...
    JDVBPlayerCOMMONImpl() {
        Log.i(TAG, "JDVBPlayerCOMMONImpl constructor is call.");
