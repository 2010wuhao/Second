 ...
 * =====================================================================
 *
 * @file  LiveGuideProgramItem.java
...
public class LiveGuideProgramItem extends FrameLayout {

    private static final String TAG = JLog.makeTag(LiveGuideProgramItem.class);
    ...
    public LiveGuideProgramItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        setId(++FocusId);
