 ...
 * ----------      ------------     -------------     -----------
 * YueLiang         2014年4月11日            1.0          Check for NULL, 0 h/w
 * =====================================================================
**/
...
public class DvbPlayer_Common extends AbsDvbPlayer {

    private MediaPlayer mMediaPlayer;
    private SurfaceHolder.Callback mCallback;

    public DvbPlayer_Common(Context context) {
        mContext = context;
    }
            ...
            public void run() {
                ...
                surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
                    ...
                    public void surfaceCreated(SurfaceHolder holder) {
                        ...
                        try {
                            mMediaPlay.setDataSource(mContext, Uri.parse("http://127.0.0.1:8080/joyseetv.m3u8"));
