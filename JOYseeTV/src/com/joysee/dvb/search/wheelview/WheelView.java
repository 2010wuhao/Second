...
public class WheelView extends View {
    ...
    public interface OnWheelScrollListener {
        void onScrollingFinished(WheelView wheel, int currentItem);
    ...
    // View adapter
    private WheelViewBaseAdapter viewAdapter;
    // Recycle
     ...
     */
    public static boolean itemCountisOne = false;

    private boolean mCenterDrawableEnable = true;
    ...
    private boolean addViewItem(int index, boolean first) {
        // JLog.d("WheelAdapter",
        // "addViewItem   index="+index+"   first="+first);
     ...
     */
    public WheelViewBaseAdapter getViewAdapter() {
        return viewAdapter;
    }
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.area_wheel_view_unfocus);
        }
    ...
    protected void notifyScrollingListenersAboutEnd() {
        for (OnWheelScrollListener listener : scrollingListeners) {
            listener.onScrollingFinished(this, currentItem);
        }
    }
    ...
    public void setCenterDrawableEnable(boolean enable) {
        mCenterDrawableEnable = enable;
    }
    ...
    public void setCurrentItem(int index, boolean animated) {
        // JLog.d("TAG", "setCurrentItem   index = "+index
        // +"  current = "+currentItem);
        if (viewAdapter == null || viewAdapter.getItemsCount() == 0) {
            return;
        }
     ...
     */
    public void setViewAdapter(WheelViewBaseAdapter viewAdapter) {
