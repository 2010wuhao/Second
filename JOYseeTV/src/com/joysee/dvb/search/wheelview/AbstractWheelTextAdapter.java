...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    public int whichAdapter = -1;

    private boolean isSplitString = false;
    ...
    protected void configureTextView(TextView view) {
        ...
        view.setLines(1);
        view.setPadding(0, textPadding, 0, textPadding);
        view.invalidate();
    }
        ...
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (isSplitString) {
                    String newStr = "";
                    try {
                        newStr = text.toString().split(splitTag)[0];
                    } catch (Exception e) {
                        newStr = (String) text;
                    }
    ...
    private View getView(int resource, ViewGroup parent) {
        switch (resource) {
            ...
            case TEXT_VIEW_ITEM_RESOURCE:
                return new JTextViewWithTTF(context, "fzltch.TTF");
            default:
    ...
    public void setEmptyItemResource(int emptyItemResourceId) {
        ...
        textSize = (int) context.getResources().getDimension(R.dimen.operator_item_text_size);
        textPadding = (int) context.getResources().getDimension(R.dimen.operator_item_text_padding);
    }
    ...
    public void setSplitByTag(boolean tag) {
        isSplitString = tag;
    }
     ...
     * Sets text color
     * 
     * @param the textColor id of text color to set
     */
