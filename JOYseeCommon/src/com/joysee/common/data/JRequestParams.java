 ...
 * {@link JAsyncHttpClient} instance. <p>&nbsp;</p> For example: <p>&nbsp;</p>
 * <pre>
...
public class JRequestParams {
     ...
     */
    public JRequestParams(Map<String, String> source) {
        init();
        if (source != null) {
     ...
     */
    public JRequestParams(final String key, final String value) {
...
//    	map.put(key, value);
     ...
     */
    public JRequestParams(Object... keysAndValues) {
        init();
     ...
     */
    public HttpEntity getEntity(JResponseInterface progressHandler) throws IOException {
    ...
    private HttpEntity createMultipartEntity(JResponseInterface progressHandler) throws IOException {
        JSimpleMultipartEntity entity = new JSimpleMultipartEntity(progressHandler);
