...
abstract class JAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory  sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
        	...
        	JLog.d(TAG, "========new Thread======== "+threadName);
    ...
    public final JAsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(sDefaultExecutor, params);
    }

    
    public final JAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final JAsyncTask<?, ?, ?> mTask;
        final Data[] mData;

        AsyncTaskResult(JAsyncTask<?, ?, ?> task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
