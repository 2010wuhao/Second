...
public abstract class JHttpJsonCallBack implements JResponseInterface {
	
    private static final String TAG = JLog.makeTag(JHttpJsonCallBack.class);
    ...
    public void onProgress(int bytesWritten, int totalSize) {
    	JLog.d(TAG, String.format("Progress %d from %d (%d)", bytesWritten, totalSize, bytesWritten / (totalSize / 100)));
    }
