 ...
 * ----------      ------------     -------------     -----------
 * benz          2013-11-26           1.0         Check for NULL, 0 h/w
 * =====================================================================
 **/
//
...
class JAsyncHttpClient {

    public static final String TAG = JLog.makeTag(JAsyncHttpClient.class);
    ...
    private JAsyncHttpClient(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
        this(getDefaultSchemeRegistry(fixNoHttpResponseException, httpPort, httpsPort));
    }

    public static JAsyncHttpClient getInstance() {
        if (mAsyncHttpClient == null) {
            synchronized (JAsyncHttpClient.class) {
                if (mAsyncHttpClient == null) {
                    mAsyncHttpClient = new JAsyncHttpClient();
                }
            }
        }
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
        if (fixNoHttpResponseException) {
            JLog.d(TAG, "Beware! Using the fix is insecure, as it doesn't verify SSL certificates.");
        }

        if (httpPort < 1) {
            httpPort = 80;
            JLog.d(TAG, "Invalid HTTP port number specified, defaulting to 80");
        }

        if (httpsPort < 1) {
            httpsPort = 443;
            JLog.d(TAG, "Invalid HTTPS port number specified, defaulting to 443");
        }
        ...
        if (fixNoHttpResponseException) {
            sslSocketFactory = JMySSLSocketFactory.getFixedSocketFactory();
        }
        else {
    ...
    public void setMaxRetriesAndTimeout(int retries, int retrySleep) {
        this.mHttpClient.setHttpRequestRetryHandler(new JRetryHandler(retries, retrySleep));
    }
     ...
     * passed Context. This will only affect requests which were created with a
    ...
    private JRequestReceipt head(String url, JResponseInterface responseInterface) {
     ...
     */
    @SuppressWarnings("unused")
    private JRequestReceipt head(String url, JRequestParams params, JResponseInterface responseHandler) {
     ...
     */
    @SuppressWarnings("unused")
    private JRequestReceipt head(Context context, String url, JResponseInterface responseHandler) {
     ...
     * the request.
     */
    private JRequestReceipt head(Context context, String url, JRequestParams params, JResponseInterface responseInterface) {
     ...
     */
    @SuppressWarnings("unused")
    private JRequestReceipt head(Context context, String url, Header[] headers, JRequestParams params, JResponseInterface responseHandler) {
     ...
     * @return
     */
    public JRequestReceipt get(Context context, String url, JRequestParams params, JResponseInterface responseHandler) {
     ...
     * @return
     */
    public JRequestReceipt get(Context context, String url, Header[] headers, JRequestParams params, JResponseInterface responseHandler) {
     ...
     * @return
     */
    public JRequestReceipt post(Context context, String url, HttpEntity entity, String contentType, JResponseInterface responseHandler) {
     ...
     * @return
     */
    public JRequestReceipt post(Context context, String url, Header[] headers, JRequestParams params, String contentType,
            JResponseInterface r) {
     ...
     * @return
     */
    public JRequestReceipt post(Context context, String url, Header[] headers, HttpEntity entity, String contentType, JResponseInterface r) {
     ...
     * @return
     */
    public JRequestReceipt put(String url, JResponseInterface responseHandler) {
     ...
     * @return
     */
    public JRequestReceipt put(String url, JRequestParams params, JResponseInterface responseHandler) {
     ...
     * @return
     */
    public JRequestReceipt put(Context context, String url, JRequestParams params, JResponseInterface responseHandler) {
     ...
     */
    public JRequestReceipt put(Context context, String url, HttpEntity entity, String contentType, JResponseInterface responseHandler) {
     ...
     * the request. And set one-time headers for the request
     */
    public JRequestReceipt put(Context context, String url, Header[] headers, HttpEntity entity, String contentType, JResponseInterface r) {
     ...
     */
    public JRequestReceipt delete(String url, JResponseInterface responseHandler) {
     ...
     * Perform a HTTP DELETE request.
     */
    public JRequestReceipt delete(Context context, String url, JResponseInterface responseHandler) {
     ...
     * Perform a HTTP DELETE request.
     */
    public JRequestReceipt delete(Context context, String url, Header[] headers, JResponseInterface responseHandler) {
        final HttpDelete delete = new HttpDelete(url);
        if (headers != null) {
     ...
     * Perform a HTTP DELETE request.
     */
    public JRequestReceipt delete(Context context, String url, Header[] headers, JRequestParams params, JResponseInterface r) {
     ...
     * @return
     */
    protected JRequestReceipt sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, //
            String contentType, JResponseInterface responseInterface, Context context) {
        ...
        Future<?> request = mThreadPool.submit(new JAsyncHttpRequest(client, httpContext, timeout, uriRequest, responseInterface));
        ...
        JLog.d(TAG, "sendRequest = " + url);
        if (url != null) {
            mUrlRequestMap.put(url, new WeakReference<Future<?>>(request));
        }

        return new JRequestReceipt(request);
    }
     ...
     */
    public static String getUrlWithQueryString(boolean shouldEncodeUrl, String url, JRequestParams params) {
        if (shouldEncodeUrl) {
            url = url.replace(" ", "%20");
        }
        if (params != null) {
        ...
        JLog.d(TAG, "add params to url=" + url);
        return url;
    }
     ...
     */
    private HttpEntity paramsToEntity(JRequestParams params, JResponseInterface responseHandler) {
