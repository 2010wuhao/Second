 ...
 */
class JSimpleMultipartEntity implements HttpEntity {

    private static final String TAG = JLog.makeTag(JSimpleMultipartEntity.class);
    ...
    private JResponseInterface progressHandler;

    private int bytesWritten;

    private int totalSize;

    public JSimpleMultipartEntity(JResponseInterface progressHandler) {
    ...
    public void addPart(final String key, final String value, final String contentType) {
        try {
        	...
        	JLog.e(TAG, "addPart ByteArrayOutputStream exception", e);
        }
    }
    ...
    public void addPart(String key, String streamName, InputStream inputStream, String type)
        ...
        try {
        	...
        	JLog.e(TAG, "Cannot close input stream", e);
        }
    }
    ...
    private class FilePart {
        ...
        private byte[] createHeader(String key, String filename, String type) {
            ...
            try {
            	...
            	JLog.e(TAG, "createHeader ByteArrayOutputStream exception", e);
            }
