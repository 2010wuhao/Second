...
public class JHttpHelper {
	...
	/**
	 * Use context to record the request, then to destroy all requests when activity onDestory()
	 * @category Perform a HTTP GET request, with parameters
	 * @param ctx
	 * @param url
	 * @param cb
	...
	/**
	 * use context to record the request, then to destroy all requests when activity onDestory()
	 * @category Perform a HTTP POST request, with parameters, HttpEntity, contentType
	 * @param ctx
	 * @param url
	 * @param entity
	 * @param contentType
	...
	/**
	 * @category Perform a HTTP POST request, with parameters, headers, content-type
	 * @param ctx
	 * @param url
	 * @param headers
	 * @param params
	...
	/**
	 * @category Perform a HTTP POST request, with parameters, headers, content-type, httpEntity
	 * @param ctx
	 * @param url
	 * @param headers
	 * @param entity
